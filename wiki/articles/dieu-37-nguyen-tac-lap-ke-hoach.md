...
article_number: 37
title: Nguyên tắc lập kế hoạch lựa chọn nhà thầu
chapter: 3
...
## Khoản 1. Phạm vi lập kế hoạch {#khoan-1}
...
## Khoản 2. Gói thầu dài hạn {#khoan-2}
...
## Khoản 5. Thời điểm lập kế hoạch {#khoan-5}
...
- Gói thầu dài hơn 1 năm phải tính giá trên toàn bộ thời gian thực hiện
- Thời điểm lập linh hoạt: sau hoặc đồng thời với lập dự án
